...
The per-type mean scores for \textsc{Llama-3.1-8B} (baseline mean 5.84) referenced in \Cref{subsec:landscape} are reported in \Cref{tab:bias_type_impact} in the main text. \Cref{fig:bias_heatmap} below shows the per-type, per-domain heatmap.
